...
CREATE TABLE IF NOT EXISTS food_items (
    ...
    starting_preparation NUMERIC DEFAULT 0.0 NOT NULL,
    created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
    updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),

    CONSTRAINT check_starting_price_non_negative CHECK (starting_price >= 0),
    CONSTRAINT check_starting_preparation_positive CHECK (starting_preparation > 0)
);
